...
export const AREAS_OBRA: AreaObra[] = [
  // 1. FUNDAÇÃO
  {
    ...
    imageUrl: "/images/areas/fundacao.jpg",
  ...
  // 2. ESTRUTURA
  {
    ...
    label: "Estrutura",
    grupo: "Estrutura & Construção",
    imageUrl: "/images/areas/estrutura.jpg",
  ...
  // 3. TERRAPLANAGEM
  {
    ...
    label: "Terraplanagem",
    grupo: "Estrutura & Construção",
    imageUrl: "/images/areas/terraplanagem.jpg",
  ...
  // 4. PAISAGISMO
  {
    ...
    imageUrl: "/images/areas/paisagismo.jpg",
  ...
  // 5. SISTEMA MONOLÍTICO
  {
    ...
    grupo: "Estrutura & Construção",
    imageUrl: "/images/areas/sistema_monolitico.jpg",
  ...
  // 6. STEEL FRAME
  {
    ...
    label: "Steel Frame",
    grupo: "Estrutura & Construção",
    imageUrl: "/images/areas/steel_frame.jpg",
  ...
  // 7. ALVENARIA CONVENCIONAL
  {
    ...
    grupo: "Estrutura & Construção",
    imageUrl: "/images/areas/alvenaria.jpg",
  ...
  // 8. TIJOLO ECOLÓGICO
  {
    ...
    grupo: "Estrutura & Construção",
    imageUrl: "/images/areas/tijolo_ecologico.jpg",
  ...
  // 9. ACABAMENTOS
  {
    ...
    imageUrl: "/images/areas/acabamentos.jpg",
  ...
  // 10. PINTURA
  {
    ...
    label: "Pintura",
    grupo: "Acabamentos & Interiores",
    imageUrl: "/images/areas/pintura.jpg",
  ...
  // 11. GESSO
  {
    ...
    label: "Gesso",
    grupo: "Acabamentos & Interiores",
    imageUrl: "/images/areas/gesso.jpg",
  ...
  // 12. DRYWALL
  {
    ...
    label: "Drywall",
    grupo: "Acabamentos & Interiores",
    imageUrl: "/images/areas/drywall.jpg",
  ...
  // 14. ARQUITETURA
  {
    ...
    label: "Arquitetura",
    grupo: "Planejamento & Projetos",
    imageUrl: "/images/areas/arquitetura.jpg",
  ...
  // 15. ENGENHARIA CIVIL
  {
    ...
    grupo: "Planejamento & Projetos",
    imageUrl: "/images/areas/engenharia_civil.jpg",
  ...
  // 21. IMPERMEABILIZAÇÃO
  {
    ...
    grupo: "Instalações & Engenharia",
    imageUrl: "/images/areas/impermeabilizacao.jpg",
  ...
  // 23. TELHADO
  {
    ...
    label: "Telhado",
    grupo: "Estrutura & Construção",
    imageUrl: "/images/areas/telhado.jpg",
  ...
  // 25. VIDRAÇARIA
  {
    ...
    label: "Vidraçaria",
    grupo: "Acabamentos & Interiores",
    imageUrl: "/images/areas/vidracaria.jpg",
  ...
  // 28. MARCENARIA
  {
    ...
    label: "Marcenaria",
    grupo: "Acabamentos & Interiores",
    imageUrl: "/images/areas/marcenaria.jpg",
  ...
  // 29. MARMORARIA
  {
    ...
    label: "Marmoraria",
    grupo: "Acabamentos & Interiores",
    imageUrl: "/images/areas/marmoraria.jpg",
  ...
  // 31. CLIMATIZAÇÃO
  {
    ...
    label: "Climatização",
    grupo: "Instalações & Engenharia",
    imageUrl: "/images/areas/climatizacao.jpg",
  ...
  // 35. REFORMAS
  {
    ...
    label: "Reformas",
    grupo: "Estrutura & Construção",
    imageUrl: "/images/areas/reformas.jpg",
  ...
  // 37. GERENCIAMENTO DE OBRAS
  {
    ...
    grupo: "Planejamento & Projetos",
    imageUrl: "/images/areas/gerenciamento_obras.jpg",
  ...
  // 40. PROJETOS
  {
    ...
    label: "Projetos",
    grupo: "Planejamento & Projetos",
    imageUrl: "/images/areas/projetos.jpg",
  ...
  // 42. CONSTRUÇÃO MODULAR
  {
    ...
    grupo: "Estrutura & Construção",
    imageUrl: "/images/areas/construcao_modular.jpg",
  ...
  // 43. PRÉ-FABRICADOS
  {
    ...
    grupo: "Estrutura & Construção",
    imageUrl: "/images/areas/pre_fabricados.jpg",
